...
@IBDesignable class HKGradientSlider: UIControl {
    ...
    private var _thumbLayer:CALayer = {
        let thumb = CALayer()
        thumb.bounds = CGRect(x: 0, y: 0, width: GradientSlider.defaultThumbSizeWidth, height: GradientSlider.defaultThumbSizeHeight)
    ...
    private var _thumbIconLayer:CALayer = {
        ...
        iconLayer.bounds = CGRect(x: 0, y: 0,
                                  width: GradientSlider.defaultThumbSizeWidth,
                                  height: GradientSlider.defaultThumbSizeHeight)
    ...
    override var intrinsicContentSize:CGSize {
        return CGSize(width: UIView.noIntrinsicMetric, height: GradientSlider.defaultThumbSizeHeight)
    }
    ...
    override func layoutSublayers(of layer: CALayer) {
        ...
        let halfSize = GradientSlider.defaultThumbSizeHeight/2.0 - 10
        _thumbIconLayer.position = CGPoint(x: halfSize, y: halfSize)
        _thumbIconLayer.bounds = CGRect(x: 0, y: 0, width: GradientSlider.defaultThumbSizeWidth, height: GradientSlider.defaultThumbSizeHeight)
    ...
    override func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
        ...
        let diameter = max(GradientSlider.defaultThumbSizeWidth,44.0)
    ...
    private func updateThumbPosition(animated: Bool){
        ...
        let trackWidth = _backgroundLayer.bounds.width - GradientSlider.defaultThumbSizeWidth / 4
